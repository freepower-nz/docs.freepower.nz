...
## 🧪 Try Environment (`try.freepower.nz`)

The `try` environment behaves **exactly the same** as our production API in terms of endpoints and authentication. However, the **underlying data** may be **mocked or limited**, especially:
